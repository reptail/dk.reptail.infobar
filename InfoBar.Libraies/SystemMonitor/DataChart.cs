...
namespace SystemMonitor
{
	...
	public class DataChart : System.Windows.Forms.UserControl
	{
		...
		private void InitializeComponent()
		{
            ...
            this.Paint += new System.Windows.Forms.PaintEventHandler(this.DataChart_Paint);
            this.Resize += new System.EventHandler(this.DataChart_Resize);
        ...
        private void DataChart_Paint(object sender, PaintEventArgs e)
        {
            /*this.BorderStyle = BorderStyle.None;
            ControlPaint.DrawBorder(e.Graphics, this.ClientRectangle, Color.WhiteSmoke, ButtonBorderStyle.Inset);*/
        }

        private void DataChart_Resize(object sender, EventArgs e)
        {
            //Invalidate();
        }
	}
